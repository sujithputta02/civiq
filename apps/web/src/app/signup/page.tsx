    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <GlassCard className="w-full max-w-md p-8 relative z-10" intensity="high">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold font-outfit text-slate-800 mb-2">Create Account</h1>
          <p className="text-slate-500">Join Civiq to start your journey</p>
        </div>
        ...
        <form onSubmit={handleEmailSubmit} className="space-y-4">
          ...
          <RefractiveButton type="submit" className="w-full mt-4" disabled={isSubmitting}>
