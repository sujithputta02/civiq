...
import { MapPin, UserCheck, FileText, Vote, ShieldCheck, ArrowRight, ArrowLeft } from 'lucide-react';
...
const simulationSteps = [
  {
    ...
    description: 'You arrive at your assigned polling station. Check the signs for the queue and ensure you are at the right location.',
  ...
  },
  {
    ...
    description: 'Provide your name and, if required in your state, your identification to the poll worker.',
  ...
  },
  {
    ...
    description: 'A poll worker will give you a paper ballot or direct you to a voting machine. Check it for any damage.',
  ...
  },
  {
    ...
    description: 'Step into the private booth. Follow the instructions carefully to mark your choices.',
  ...
  },
  {
    ...
    description: 'Insert your ballot into the scanner or submission box. Wait for confirmation that it was accepted.',
  ...
  return (
    <div className="min-h-screen bg-[#0F172A] text-white py-12 px-8 overflow-hidden relative">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        <Link href="/dashboard" className="inline-flex items-center gap-2 text-slate-400 hover:text-white mb-12 transition-colors">
          <ArrowLeft size={18} /> Exit Simulation
        </Link>

        <div className="mb-12">
          <h1 className="text-4xl font-bold mb-4">Polling Day Simulation</h1>
          <p className="text-slate-400">A digital rehearsal to reduce anxiety and build procedural confidence.</p>
        </div>
              ...
              <div className="pt-8">
                ...
                <div className="flex justify-between items-center">
                  ...
                  {currentStep === simulationSteps.length - 1 ? (
                    <Link href="/dashboard">
                      <RefractiveButton size="lg" className="bg-green-600 hover:bg-green-500 shadow-green-600/25">
                        Finish Simulation
                      </RefractiveButton>
                    </Link>
                  ) : (
